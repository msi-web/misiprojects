/**
 * Process Flow Diagram Connectors - Draws horizontal lines between consecutive process nodes (desktop)
 * Mobile uses CSS-based vertical connectors via ::before pseudo-elements
 */

function initProcessFlowConnectors() {
  ...
  function updateConnectors() {
    ...
    if (nodePairs.length >= 2) {
      ...
      const curveBottomY = container.offsetHeight - 25;
      const curveControlY = container.offsetHeight + 35;
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', initProcessFlowConnectors);
} else {
  initProcessFlowConnectors();
}/**
 * Process Flow Diagram Connectors - Draws horizontal lines between consecutive process nodes (desktop)
 * Mobile uses CSS-based vertical connectors via ::before pseudo-elements
 */
